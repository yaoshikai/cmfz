...
import com.baizhi.ysk.controller.conf.RandomIdentifyUtil;
import com.baizhi.ysk.controller.dto.ErrorDto;
import com.baizhi.ysk.controller.dto.IdentifyDto;
import com.baizhi.ysk.controller.service.IdentifyService;
...
public class IdentifyServiceImpl implements IdentifyService {
    ...
    public void obtain(String phone) throws ClientException {
        if (phone != null) {
            /*生成随机验证码*/
            String identifyCode = RandomIdentifyUtil.getIdentifyCode();
            ...
            if (sendSmsResponse.getCode() != null && sendSmsResponse.getCode().equals("OK")) {
                ...
                ops.set("identifyCode", identifyCode, 300, TimeUnit.SECONDS);
            }
    ...
    public Object check(String phone, String code) {
        ...
        if (identifyCode != null) {
            if (identifyCode.equals(code)) {
                return new IdentifyDto("success");
            } else {
                return new IdentifyDto("fail");
            }
        } else {
            return new ErrorDto(206, "验证码已失效");
        }
    }
}
